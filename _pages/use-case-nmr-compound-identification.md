  ...
  <div class="container custom_container">
    <div class="row g-4 justify-content-center text-center">
      <div class="col-12 col-lg-9">
        <h2 class="fw-bold text-dark" style="font-size: 30px;">Where identification slows down</h2>
        <p class="text-dark mt-3">
  ...
  <div class="container custom_container">
    <div class="row g-4 align-items-start">
      <div class="col-12 col-lg-5">
        ...
        <div class="mt-4">
          {% include ui/button.html href="https://spectra.rombo.ai" label="Analyze a spectrum" class="button-lg" location="use_case_nmr_compound_solution" %}
        </div>
      </div>
      <div class="col-12 col-lg-7">
        <div class="row g-3">
          ...
          <div class="col-12 col-md-6">
            <div class="p-4 border rounded-4 h-100 text-start" style="background:#fff;">
              ...
              <p class="text-dark mb-0" style="font-size: 14px;">The model flags the features that discriminate candidates, so you skip the repetitive first pass.</p>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="p-4 border rounded-4 h-100 text-start" style="background:#fff;">
...
<section class="container-fluid text-center text-white py-5" style="background: linear-gradient(135deg, #303767, #3d4580);">
  <div class="container custom_container">
    ...
    <div class="mt-4 d-flex justify-content-center">
      {% include ui/button.html href="https://spectra.rombo.ai" label="Go to Spectra" class="button-lg" location="use_case_nmr_compound_footer" %}
    </div>
  </div>
</section>
